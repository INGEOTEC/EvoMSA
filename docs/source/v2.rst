...
classes :ref:`BoW`, :ref:`TextRepresentations`, 
and :ref:`StackGeneralization`. 
:ref:`BoW` and :ref:`TextRepresentations` are text
classifiers; :ref:`BoW` is the parent of :ref:`TextRepresentations`.
The stack generalization technique is implemented in 
:ref:`StackGeneralization`.
